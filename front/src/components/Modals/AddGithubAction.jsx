...
const ModalSettingsGithubAction = ({addElement, setData}) => {

    const classes = useStyles();

    const [repo, setRepo] = useState("godotengine/godot");
    const save = () => {
        setData({...addElement, data: {
            repo: repo,
            title: "Github action",
            type: "GithubAction",
            description: "GITHUBBBBBBBBBB",
            size: 6,
        }})
    };
...
export default ModalSettingsGithubAction;