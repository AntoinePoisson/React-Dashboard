...
const ModalSettingsImgurPostImage = ({addElement, setData}) => {

    const classes = useStyles();

    const [input, ] = useState({
            title: "Imgur Upload Image",
            type: "ImgurPostImage",
            description: "Imgur send Picture",
            size: 6,
        })
...
export default ModalSettingsImgurPostImage;