...
import BodyGithubIssue from './Body/GithubIssue';
import DataContext from '../../../../contexts/dataContext';

const WidgetGithubIssue = ({index, list, setList}) => {
    ...
    useEffect(() => {
        ...
        fetch(`https://api.github.com/repos/${list[index].repo}/issues`, myInit)
            .then(async res => {
...
export default WidgetGithubIssue;